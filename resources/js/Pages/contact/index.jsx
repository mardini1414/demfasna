          ...
          <div className="space-y-5">
            ...
            <div>
              <img
                src={ImageSuccess}
                alt="mail success"
                className="flex w-full shadow-md  md:max-w-md rounded-lg justify-center"
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="space-x-4">
                <a href="#">
                  <i className="fa-brands fa-twitter border-2 hover:border-0 border-blue-400  text-3xl hover:bg-blue-400 hover:text-white text-blue-400 bg-white  min-w-wull p-2 rounded-full duration-500"></i>
                </a>
                <a href="https:/instagram.com/demfasna?igshid=Yzg5MTU1MDY=">
                  <i className="fab fa-instagram border-2 hover:border-0 border-pink-500 bg-gradient-to-b text-3xl hover:from-indigo-600 hover:via-pink-600 hover:to-yellow-500 min-w-wull hover:text-white bg-white text-pink-600 p-2 rounded-full duration-500"></i>
                </a>

                <a href="https:/youtube.com/@demfasna">
                  <i className="fa-brands fa-youtube text-3xl bg-white border-2 p-2 rounded-full duration-500 text-red-500 border-red-500 hover:bg-red-500 hover:text-white"></i>
                </a>
              </div>
            </div>
          </div>
