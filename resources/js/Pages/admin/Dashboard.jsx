          ...
          <div className="flex flex-col flex-auto flex-shrink-0 min-h-screen antialiased text-black bg-white dark:bg-gray-700 dark:text-white">
            ...
            <div className="h-full mb-10 ml-14 mt-14 md:ml-64">
              ...
              <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="flex items-center justify-between p-3 font-medium text-white bg-blue-500 border-b-4 border-blue-600 rounded-md shadow-lg dark:bg-gray-800 dark:border-gray-600 group">
                  ...
                  <div className="px-0 mb-0 border-0 rounded-t">
                    <div className="flex flex-wrap items-center px-4 py-2">
                      ...
                      <div className="relative flex-1 flex-grow w-full max-w-full text-right">
                        <button
                          className="px-3 py-1 mb-1 mr-1 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 rounded outline-none dark:bg-gray-100 active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 focus:outline-none"
                          type="button"
                        >
                          See all
                        </button>
                    ...
                    <div className="block w-full overflow-x-auto">
                      <table className="items-center w-full bg-transparent border-collapse">
                        <thead>
                          <tr>
                            <th className="px-4 py-3 text-xs font-semibold text-left text-gray-500 uppercase align-middle bg-gray-100 border border-l-0 border-r-0 border-gray-200 border-solid dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500 whitespace-nowrap">
                              Referral
                            </th>
                            <th className="px-4 py-3 text-xs font-semibold text-left text-gray-500 uppercase align-middle bg-gray-100 border border-l-0 border-r-0 border-gray-200 border-solid dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500 whitespace-nowrap">
                              Visitors
                            </th>
                            <th className="px-4 py-3 text-xs font-semibold text-left text-gray-500 uppercase align-middle bg-gray-100 border border-l-0 border-r-0 border-gray-200 border-solid dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500 whitespace-nowrap min-w-140-px" />
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      <ul className="my-1">
                        <li className="flex px-4">
                          <div className="flex-shrink-0 my-2 mr-3 bg-indigo-500 rounded-full w-9 h-9">
                            <svg
                              className="fill-current w-9 h-9 text-indigo-50"
                              viewBox="0 0 36 36"
                            >
                        ...
                        <li className="flex px-4">
                          <div className="flex-shrink-0 my-2 mr-3 bg-red-500 rounded-full w-9 h-9">
                            <svg className="fill-current w-9 h-9 text-red-50" viewBox="0 0 36 36">
                  ...
                  <form className="flex flex-col justify-center p-6">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        className="px-3 py-3 mt-2 font-semibold text-gray-800 bg-white border border-gray-400 rounded-lg w-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-50 focus:border-blue-500 focus:outline-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="px-6 py-3 mt-4 font-bold text-white transition duration-300 ease-in-out bg-blue-600 rounded-lg md:w-32 dark:bg-gray-100 dark:text-gray-800 hover:bg-blue-500 dark:hover:bg-gray-200"
                    >
                      Submit
                    </button>
                  </form>
              ...
              {/* External resources */}
              <div className="mx-4 mt-8">
                <div className="p-4 border border-blue-500 rounded-lg shadow-md bg-blue-50 dark:bg-gray-800 dark:text-gray-50 dark:border-gray-500">
